...
public class modelFox extends ModelBase {
	...
	public modelFox() {
		...
		this.wolfBody = new ModelRenderer(this, 18, 12);
		this.wolfBody.addBox(-4.0F, -7F, -3.0F, 6, 14, 6, f);
	...
	//	this.wolfMane.setRotationPoint(-1.0F, 14.0F, 2.0F);
		...
		this.wolfHeadMain.setTextureOffset(21, 0).addBox(-7F, -2.0F, -1.0F, 4, 3, 1, f);
		this.wolfHeadMain.setTextureOffset(31, 0).addBox(3F, -2.0F, -1.0F, 4, 3, 1, f);
	}
